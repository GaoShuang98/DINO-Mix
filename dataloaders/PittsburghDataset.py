...
DATASET_ROOT = 'D:\python_code\MixVPR\datasets\Pittsburgh250k/'
GT_ROOT = r'D:\zcl\zcl_MixVPR-main(traincopy)\datasets/' # BECAREFUL, this is the ground truth that comes with GSV-Cities
