...
root_dir = 'D:\python_code\MixVPR\datasets\Pittsburgh250k\\'
# root_dir = "E:\Pytorch_code\MixVPR\datasets\Pittsburgh250k\\"
...
class WholeDatasetFromStruct(data.Dataset):
    def __init__(self, structFile, input_transform=None, onlyDB=False):
        ...
        self.num_references = self.dbStruct.numDb
        self.num_queries = len(self.dbStruct.qImage)
        self.ground_truth = self.getPositives()
        self.qImages = self.images
        # self.dbImages = self.images
